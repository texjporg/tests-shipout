% based on `eso-memoir-test.tex' in eso-pic by Rolf Niepraschk
\let\printglossary\undefined % for pLaTeX

\setcounter{errorcontextlines}{100}
\listfiles
\documentclass[twoside,a4paper,showtrims,dvipdfmx]{memoir}
%------------------------------------
\stockaiii
